...
- This was tested on 2026-02-12 with the old version of hardware by ripping out the voltage divider resistors and using the zenerdiode as the regulating element, as it should be.
